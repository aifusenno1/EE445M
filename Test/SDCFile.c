...
void FileSystemTest(void){
  ...
  if(Fresult){
    ST7735_DrawString(0, 0, "test error", ST7735_Color565(0, 0, 255));
  ...
  if(Fresult == FR_OK){
    ST7735_DrawString(0, 0, "Opened test.txt", ST7735_Color565(0, 0, 255));
    for(i=0; i<FILETESTSIZE; i++){
      n = (16807*n)%2147483647; // pseudo random sequence
    ...
    ST7735_DrawString(0, 0, "Error test.txt (  )", ST7735_Color565(255, 0, 0));
