...
void ADC_Open(uint32_t channelNum) {
	...
	TIMER2_TAMR_R = 0x00000001;   // configure for one-shot mode, default down-count settings
	TIMER2_TAPR_R = 0;            // prescale value for trigger
	TIMER2_TAILR_R = 8000-1;    // 10000 Hz sampling rate, 80 MHz clock
...
static volatile uint32_t ADC0SS3_value;
...
void ADC0Seq2_Handler(void){
	...
	ADC0SS2_buffer[buffer_size++] = ADC0_SSFIFO2_R;
}
