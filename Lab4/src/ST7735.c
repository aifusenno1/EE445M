...
void ST7735_OutUDec(unsigned long n){
  ...
  ST7735_DrawString(Cursor,StLine,Message,ST7735_YELLOW);
}
...
void LCD_Init(){
	// currently, OutString and Message are the only functions implemented mutex
